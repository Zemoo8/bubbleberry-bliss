...
export const flavors: Flavor[] = [
  ...
  { id: "choco",    name: "Chocolat", color: "oklch(0.5 0.09 60)",   deep: "oklch(0.3 0.07 50)",   hue: 30,  notes: "Rich, cocoa-deep, dessert-sweet", notesFr: "Riche, cacao intense, gourmand",     pairing: "Chocolate tapioca", pairingFr: "tapioca au chocolat" },
